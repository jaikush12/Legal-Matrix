...
class MonthCalendar extends StatelessWidget {
  ...
  List<Widget> _buildDaysOfWeek() {
    ...
    return daysOfWeek
        ...
        child: Text(
          day,
          style: TextStyle(color:Color(0xFF535353),fontWeight: FontWeight.w500, fontSize: 8),
        ),
      ),
    )
        .toList();
      ...
      if("23" == day.toString()){
        ...
        calendarDays.add(
          Container(
            ...
            alignment: Alignment.center,
            child: Text(day.toString(),style: TextStyle(color:Textcolor,fontWeight: FontWeight.w500, fontSize: 8),),
          ),
        );
